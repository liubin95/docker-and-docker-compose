...
# docker exec -it redis2 redis-cli -c -h redis2 -p 7001
# ./Redis-trib.rb对本机名设别不了，支持的不是很好 换成ip:port的方式
redis-cli --cluster create 172.18.0.2:7001 172.18.0.5:7001 172.18.0.8:7001
# 查看集群信息
redis-cli -c -h redis2 -p 7001 cluster info
# 查看节点
redis-cli -c -h redis2 -p 7001 cluster nodes
# 节点 加副本
...
# 查看主从关系
redis-cli -c -h redis2 -p 7001 info replication